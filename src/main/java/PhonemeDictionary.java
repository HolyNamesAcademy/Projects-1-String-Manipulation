...
public class PhonemeDictionary {
    ...
    public static PhonemeDictionary getDictionary() {
        if(instance == null) {
            return new PhonemeDictionary("resources/cmudict.0.7a.txt");
        }
    ...
    private String getWordFromLine(String line) {
        ...
        if(indexOfParen != -1 && indexOfParen > 0) {
            return word.substring(0, indexOfParen);
        }
        return word.trim();
    }
